"""Tests for HistoricalVaRCalculationService.

Tests orchestration of VaR calculation and persistence workflow.
"""
...
from manco_risk.database.var_calculation_service import HistoricalVaRCalculationService
from manco_risk.etl.enriched_position import EnrichedPosition, RiskReadyPortfolio
from manco_risk.risk.exceptions import MissingHistoricalDataError, UnsupportedAssetClassError
